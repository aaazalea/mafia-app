...
CONSPIRACY_LIST_SIZE = 15

CYNIC_LIST_SIZE_IS_PERCENT = True
CYNIC_LIST_SIZE = 15
# TODO discuss optimal cynic list size settings

PRIEST_LIST_SIZE_IS_PERCENT = True
PRIEST_LIST_SIZE = 20
...
CLUES_IN_USE = False
ONE_INVESTIGATION_PER = True

MAYOR_COUNT_MAFIA_TIMES = 2

KABOOMS_REGENERATE = True

TRAPS_REGENERATE = True
